...
表記例: **1章1節1項** = 第1章 ゲームエンジン基礎 第1節 基礎 第1項（旧 Step 1）。
...
| **第2章 ゲームエンジン応用** | 第1節 Rust lib 分割・整理 | 1項〜 | lib.rs の分割・フォルダ構成。3D・Slot の**前**に実施（[STEPS_RUST_LIB.md](./STEPS_RUST_LIB.md)） | R-LIB |
...
| 7項 | ゲームループ（GenServer 60 Hz） | ※1章5節7項（旧 Step 41）で Rust に移行 | 7 |
| 8項 | プレイヤー移動 | | 8 |
| 9項 | 敵スポーン・追跡 AI | | 9 |
...
**表記**: 第1章第2節第1項 = **1章2節1項**。以下、章・節内では「○項」と略記する。
...
| 5項 | デバッグ支援（NIF） | | 45 |
| 6項 | GameLoop を GameEvents にリネーム | Elixir 側の役割に合わせてモジュール名を変更 | 46 |
...
### 第2章 第1節 Rust lib 分割・整理（2章1節）

| 項 | 目標 | 旧 |
|-----|------|-----|
| 1項 | lib.rs 分割・フォルダ構成（world / game_logic / nif 等） | R-LIB |
