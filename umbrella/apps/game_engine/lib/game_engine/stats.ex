# Path: umbrella/apps/game_engine/lib/game_engine/stats.ex
...
defmodule GameEngine.Stats do
  ...
  def new_session, do: GenServer.cast(__MODULE__, :new_session)

  def session_summary, do: GenServer.call(__MODULE__, :summary)
  ...
  def handle_cast({:kill, enemy_kind, weapon_kind}, state) do
    ...
    {:noreply, %{state | kills_by_enemy: kills_by_enemy, kills_by_weapon: kills_by_weapon, total_kills: total_kills}}
  end
